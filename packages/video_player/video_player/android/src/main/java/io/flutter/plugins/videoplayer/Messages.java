...
public class Messages {
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static class ResolutionMessage {
    private Long textureId;
    ...
    static ResolutionMessage fromMap(HashMap map) {
      ResolutionMessage fromMapResult = new ResolutionMessage();
      Object textureId = map.get("textureId");
      fromMapResult.textureId =
          (textureId == null)
              ? null
        ...
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                try {
                  @SuppressWarnings("ConstantConditions")
                  ResolutionMessage input = ResolutionMessage.fromMap((HashMap) message);
